...
const renderListItems = (listItems) => {
  ...
  const newListOfEl = listItems.map(({ text }, done) => {
    // перебираем объект с текстом для новых эл-тов
    ...
    if (done) newEl.classList.add('list__item-done');  // если checked - добавляем другой класс
